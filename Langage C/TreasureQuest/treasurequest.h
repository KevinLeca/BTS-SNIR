...
void afficheSortie();
void affichePerdu();
void afficherPersonnage(typePersonnage *personnage);//Affiche les détails d'un personnage
float getDistance(unsigned int xt,unsigned int yt,unsigned int xp,unsigned int yp);
int CalculDegats(typePersonnage *attaquant, typePersonnage *defenseur); //Calcul et renvoi les dégats
